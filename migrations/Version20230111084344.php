 ...
 */
final class Version20230111084344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE testou (id INT AUTO_INCREMENT NOT NULL, testou DATETIME NOT NULL, testouu DATETIME DEFAULT NULL, testouuu VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
