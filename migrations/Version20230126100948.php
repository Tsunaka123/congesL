 ...
 */
final class Version20230126100948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delegation ADD id_user_delegant_d INT NOT NULL, DROP id_user_delegant_d, CHANGE id_user_delegue_d id_user_delegue_d INT NOT NULL');
        $this->addSql('ALTER TABLE delegation ADD CONSTRAINT FK_292F436D891D292D FOREIGN KEY (id_user_delegant_d) REFERENCES utilisateur (id)');
        $this->addSql('CREATE INDEX IDX_292F436D891D292D ON delegation (id_user_delegant_d)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON delegation');
        $this->addSql('ALTER TABLE delegation ADD id_user_delegant_d INT NOT NULL COMMENT \'Charge idUserDelegueD de poser ses congés à sa place\', DROP id_user_delegant_d, CHANGE id_user_delegue_d id_user_delegue_d INT NOT NULL COMMENT \'Chargé de poser les congés\'');
        $this->addSql('ALTER TABLE delegation ADD PRIMARY KEY (id_user_delegue_d, id_user_delegant_d)');
